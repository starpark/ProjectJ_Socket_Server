...
class Item final :
 ...
 public:
  ...
  int32_t is_rotated() const;
  void set_is_rotated(int32_t value);
  private:
  int32_t _internal_is_rotated() const;
  void _internal_set_is_rotated(int32_t value);
  public:
...
inline void Item::clear_is_rotated() {
  _impl_.is_rotated_ = 0;
}
inline int32_t Item::_internal_is_rotated() const {
  return _impl_.is_rotated_;
}
inline int32_t Item::is_rotated() const {
  // @@protoc_insertion_point(field_get:ProjectJ.Item.is_rotated)
  return _internal_is_rotated();
}
inline void Item::_internal_set_is_rotated(int32_t value) {
  
  _impl_.is_rotated_ = value;
}
inline void Item::set_is_rotated(int32_t value) {
